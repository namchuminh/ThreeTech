...
<div class="contact_info">
					...
					<div class="contact_form_container">
						...
						<form action="#" id="contact_form">
							<div class="contact_form_inputs d-flex flex-md-row flex-column justify-content-between align-items-between">
								...
								<input type="text" id="contact_form_email" class="contact_form_email input_field" placeholder="Địa chỉ Email" required="required" data-error="Email is required.">
								<input type="text" id="contact_form_phone" class="contact_form_phone input_field" placeholder="Số điện thoại">
							</div>
							<div class="contact_form_text">
								<textarea id="contact_form_message" class="text_field contact_form_message" name="message" rows="4" placeholder="Tin nhắn" required="required" data-error="Bạn chưa điền tin nhắn."></textarea>
							</div>
	...
	<div id="map" style="width:1500px;height:450px;">
    <iframe src="https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d426.7633605920663!2d105.78988211802731!3d21.068266985264433!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x3135abd4211d9eed%3A0x92d1fd897780174f!2zTmjDoCB0cuG7jSBraGFuZw!5e0!3m2!1svi!2s!4v1670773549735!5m2!1svi!2s" width="1500" height="450" style="border:0;" allowfullscreen="" loading="lazy" referrerpolicy="no-referrer-when-downgrade"></iframe>
</div>
