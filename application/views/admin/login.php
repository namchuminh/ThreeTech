...
<head>
    ...
    <title>Admin ThreeTech - Đăng Nhập</title>
                            ...
                            <div class="col-lg-6">
                                <div class="p-5">
                                    <div class="text-center">
                                        <h1 class="h4 text-gray-900 mb-4">Đăng Nhập - Admin ThreeTech</h1>
                                    </div>
                                    <form method="POST" class="user" action="<?php echo base_url('admin/auth/actionLogin/')?>">
                                        <div class="form-group">
                                            <input type="text" name="taikhoan" class="form-control form-control-user"
                                                id="exampleInputEmail" aria-describedby="emailHelp"
                                                placeholder="Nhập tài khoản...">
                                        </div>
                                        <div class="form-group">
                                            <input type="password" class="form-control form-control-user"
                                                id="exampleInputPassword" name="matkhau" placeholder="Nhập mật khẩu...">
                                        </div>
                                        <div class="form-group">
                                        ...
                                        <?php if(isset($error)){ ?>
                                            <div class="text-center">
                                                <span style="font-weight: bold; color: red;" class="small" ><?php echo $error; ?></span>
                                            </div>
                                        <?php }?>
                                    </form>
                                    <div class="text-center">
