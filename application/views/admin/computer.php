...
<div class="container-fluid">
                    ...
                    <!-- Page Heading -->
                    <h1 class="h3 mb-2 text-gray-800">Máy Tính</h1>
                    <p class="mb-4">Dữ liệu được lấy trong bảng sản phẩm, bao gồm các thông tin liên quan đến sản phẩm Máy tính.</p>

                    <!-- DataTales Example -->
                    <div class="card shadow mb-4">
                        <div class="card-header py-3">
                            <h6 class="m-0 font-weight-bold text-primary">Tất cả: Máy Tính</h6>
                        </div>
                        <div class="card-body">
                                    ...
                                    <?php foreach ($product as $key => $value): ?>
                                        <tr class="odd">
                                            ...
                                            <td style="line-height: 50px;">
                                                ...
                                                <a class="btn btn-danger deleteProductAction" value="<?php echo $value['sanPhamId']; ?>" href="#" data-toggle="modal" data-target="#deleteModal">Xóa<input type="hidden" class="cate" value="may-tinh"></a>
                                            </td>
                                        </tr>
                                    <?php endforeach ?>   
